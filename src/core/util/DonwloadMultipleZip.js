...
const DonwloadMultipleZip = async ( data, zipFilename ) => {
    ...
    zip.generateAsync({ type: "blob" }).then(function (content) {
        ...
        link.href = url.createObjectURL(content) /*result.data_file.slice(result.data_file.indexOf(',')+1) */
    ...
    const convertBlobToBase64 = (blob) => new Promise((resolve, reject) => { //blob to base64
