...
import DocumentDepartPage from "./pages/DepartPage";
				...
				>
					...
					>
						...
						<Menu.Item
							...
							icon={<TeamOutlined />}
						>
							<NavLink to="/admin/registration">Пользователи</NavLink>
						</Menu.Item>
						<Divider style={{ margin: 0 }} />
						<Menu.Item
							style={{ marginTop: 2, marginBottom: 2 }}
							key="/admin/positions-page"
							icon={<TeamOutlined />}
						>
							<NavLink to="/admin/positions-page">Должности</NavLink>
						</Menu.Item>
						<Divider style={{ margin: 0 }} />
						<Menu.Item
							style={{ marginTop: 2, marginBottom: 2 }}
							key="/admin/document-statuses-page"
							icon={<TeamOutlined />}
						>
							<NavLink to="/admin/document-statuses-page">
								Статусы документов
							</NavLink>
						</Menu.Item>
						<Divider style={{ margin: 0 }} />
						<Menu.Item
							style={{ marginTop: 2, marginBottom: 2 }}
							key="/admin/document-routes-page"
							icon={<TeamOutlined />}
						>
							<NavLink to="/admin/document-routes-page">
								Маршруты документов
							</NavLink>
						</Menu.Item>
						<Divider style={{ margin: 0 }} />
						<Menu.Item
							style={{ marginTop: 2, marginBottom: 2 }}
							key="/admin/forms-settings-page"
							icon={<TeamOutlined />}
						>
							<NavLink to="/admin/forms-settings-page">Настройки форм</NavLink>
						</Menu.Item>
						<Divider style={{ margin: 0 }} />
						<Menu.Item
							style={{ marginTop: 2, marginBottom: 2 }}
							key="/admin/department-page"
							icon={<TeamOutlined />}
						>
							<NavLink to="/admin/department-page">Департаменты</NavLink>
						</Menu.Item>
						<Divider style={{ margin: 0 }} />
				...
				<Layout className="content-layout">
					<Content>
						<div className="site-layout-background" style={{ minHeight: 360 }}>
							...
							<Route
								path="/admin/positions-page"
								component={DocumentPositionsPage}
							/>
							<Route
								path="/admin/document-statuses-page"
								component={DocumentStatusesPage}
							/>
							<Route
								path="/admin/document-routes-page"
								component={DocumentRoutesPage}
							/>
							<Route
								path="/admin/forms-settings-page"
								component={FormSettingsPage}
							/>
							<Route
								path="/admin/department-page"
								component={DocumentDepartPage}
							/>
						</div>
					</Content>
				</Layout>
