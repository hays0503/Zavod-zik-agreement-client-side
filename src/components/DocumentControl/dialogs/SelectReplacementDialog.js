...
const SelectReplacementDialog = React.memo((props) => {
  const positions = {
    exemplar: 'positions',
    table: 'positions',
    options: {
                    ...
                    <Popconfirm
                        ...
                        onConfirm={async () => {
                          ...
                          props.setRoutesList(prevState => {
                            ...
                            const tmpIndex = old[0].substitutes.indexOf(props.routeData[props.stepCount.step - 1].positionId)
