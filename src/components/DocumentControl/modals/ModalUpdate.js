...
let ModalUpdate = React.memo(
	({
		...
		let commentVariables = props?.selectedRowKeys[0]
			? {
					variables: {
						document_comments: {
							global: {
		...
		let handleRouteFromUserEditToApprove = () => {
		...
		let handleRouteFromUserEditToApprove2 = () => {
			//user send to approve
			let routeCurrentIndex = data2.documents[0].step;
		...
		let handleRouteFromUserEditToApprove3 = () => {
			//user send to approve
			let routeCurrentIndex = data3.documents[0].step;
		...
		let handleRouteFromUserEditToApprove4 = () => {
			//user send to approve
			let routeCurrentIndex = data4.documents[0].step;
		...
		let handleRouteFromUserEditToApprove5 = () => {
			//user send to approve
			let routeCurrentIndex = data5.documents[0].step;
