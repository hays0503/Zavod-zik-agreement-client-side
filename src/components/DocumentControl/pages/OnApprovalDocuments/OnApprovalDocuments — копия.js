...
let OnApprovalDocuments = React.memo((props) => {
    ...
    let dict = test([
        { title: 'Наименование', dataIndex: 'title', width: '214px', type: 'search', tooltip: true, sorter: true },
        { title: 'От кого', dataIndex: 'user_info', width: '114px', type: 'search', tooltip: true, sorter: true },
        { title: 'Дата создания', dataIndex: 'date_created', width: '114px', type: 'search', tooltip: true, sorter: true },
        { title: 'Дата изменения', dataIndex: 'date_modified', width: '114px', type: 'search', tooltip: true, sorter: true },
        { title: 'Маршрут', dataIndex: 'route', width: '114px', type: 'search', tooltip: true, sorter: true },
        { title: 'Статус', dataIndex: 'status', width: '80px', tooltip: true, sorter: true },
        { title: 'У кого', dataIndex: 'step_name', width: '114px' },
        { title: 'Маршрут.', dataIndex: 'step_count', width: '55px' },
