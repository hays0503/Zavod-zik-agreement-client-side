...
let Account = React.memo((props) => {
	...
	const [dataPassword, { loading: loadingMutation, error: errorMutation }] =
					...
					<Sider theme="dark" style={{ color: "#fff" }}>
						...
						<Statistic
							...
							value={
								...
								versionData.application[0] != null
									? versionData.application[0].platform_version
									: null
							}
						/>
						<Statistic
							...
							value={
								...
								versionData.application &&
								versionData.application[0] != null
									? versionData.application[0].database_version
									: null
							}
						/>
					</Sider>
					<Content>
						<Space direction="vertical">
							...
							<Input.Password
								...
								value={password}
								onChange={handlerInput1}
								className="accountInput"
								iconRender={(visible) =>
									visible ? (
										<EyeTwoTone
											className="accountEyeTwoTone"
											style={{ color: "#2C3E50" }}
										/>
									) : (
